...
> **Note:** This page documents the **parsedmarc command-line interface (CLI)**. If you
> are using the **Web GUI**, see the [Web GUI Guide](web-gui.md) for browser-based usage
